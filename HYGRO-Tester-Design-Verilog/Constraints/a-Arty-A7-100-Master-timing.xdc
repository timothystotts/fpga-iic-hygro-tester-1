...
set_output_delay -clock [get_clocks wiz_20mhz_virt_out] -min -add_delay -0.700 [get_ports eio_sda]
set_output_delay -clock [get_clocks wiz_20mhz_virt_out] -max -add_delay 6.000 [get_ports eio_sda]
